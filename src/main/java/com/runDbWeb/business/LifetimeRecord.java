...
public class LifetimeRecord {
    ...
    public LifetimeRecord() {
    	logger.info("RunDb3 Application LifetimeRecord() constructor 001 - Logging INFO");
        init();
    }
    ...
    public ArrayList<ArrayList<String>> getLifetimeData() {
    	logger.debug("RunDb3 Application getLifetimeData() method 001 - Logging DEBUG");
        ResultSet rs3;
    ...
    public ArrayList<ArrayList<String>> getLifetimeRecs(ArrayList<ArrayList<String>> dataTable) {
    	logger.debug("RunDb3 Application getLifetimeRecs() method 001 - Logging DEBUG");
